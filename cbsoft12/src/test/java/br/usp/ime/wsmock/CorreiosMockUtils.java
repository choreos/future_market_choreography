...
public class CorreiosMockUtils {
	...
	// private final String CORREIOS_WSDL =
	// "http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx?WSDL";

	public WSMock buildWSMock() throws Exception {
		String correiosWSDL = "file://" + System.getProperty("user.dir")
				+ "/resources/calc_preco_prazo.wsdl";
	...
	public Item buildRequest(boolean withSedex) {
		...
		request.addChild("nCdEmpresa").setContent("?");
