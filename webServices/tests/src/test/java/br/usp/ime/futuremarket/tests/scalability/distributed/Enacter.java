...
//    private static final String REPO = "http://www.linux.ime.usp.br/~cadu/futuremarket/";
    ...
    private Map<String, String> deployedServices = new HashMap<String, String>();
...
//        spec.addServiceSpec(getServiceSpec("supplier3"));
    ...
    private ChorSpec getPortalSpec(int index) {
    	final ChorSpec spec = new ChorSpec();
    ...
    private ChorServiceSpec getLegacyRegistrySpec(String name) {
        ...
        service.setEndpointName(deployedServices.get(REG_NAME));
