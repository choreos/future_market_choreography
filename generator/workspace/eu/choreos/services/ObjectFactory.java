 ...
 * generated in the eu.choreos.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPriceResponse_QNAME = new QName("http://services.choreos.eu/", "getPriceResponse");
    private final static QName _GetPrice_QNAME = new QName("http://services.choreos.eu/", "getPrice");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: eu.choreos.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.choreos.eu/", name = "getPriceResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.choreos.eu/", name = "getPrice")
