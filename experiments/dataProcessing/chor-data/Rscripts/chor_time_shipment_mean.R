...
chor_data <- list(read.table("data/chor/time/050/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/100/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/150/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/200/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/250/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/300/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/350/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/400/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/450/shipment.log",head=FALSE,sep=" "), read.table("data/chor/time/500/shipment.log",head=FALSE,sep=" "))
...
# Plot
	png("png/xtended_mean_chor_shipment.png")
