...
orch_data <- list(read.table("data/orch/time/001/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/002/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/003/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/004/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/005/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/006/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/007/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/008/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/009/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/010/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/011/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/012/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/013/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/014/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/015/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/016/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/017/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/018/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/019/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/020/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/050/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/100/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/150/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/200/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/250/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/300/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/350/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/400/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/450/shipment.log",head=FALSE,sep=" "), read.table("data/orch/time/500/shipment.log",head=FALSE,sep=" "))
...
# Plot
	png("png/xtended_95_all_time_shipment.png")
